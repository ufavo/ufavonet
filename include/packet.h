 ...
 * Returns `enum packeterr` error code. */
int packet_set_length(packet_t *restrict p, const uint32_t value);
 ...
 * Returns `enum packeterr` error code. */
int packet_w_64_t(packet_t *restrict p, const void *restrict ptr);
/* Adds 4 bytes from `ptr` to `p`.
 *`packet_r_32_t` should be used for reading.
 * Returns `enum packeterr` error code. */
int packet_w_32_t(packet_t *restrict p, const void *restrict ptr);
/* Adds 2 bytes from `ptr` to `p`.
 *`packet_r_16_t` should be used for reading.
 * Returns `enum packeterr` error code. */
int packet_w_16_t(packet_t *restrict p, const void *restrict ptr);
/* Adds 1 byte from `ptr` to `p`.
 *`packet_r_8_t` or `packet_r` should be used for reading.
 * Returns `enum packeterr` error code. */
int packet_w_8_t(packet_t *restrict p, const void *restrict ptr);
 ...
 * Returns `enum packeterr` error code. */
int packet_w_vlen29(packet_t *restrict p, const uint32_t value);

/* Returns `enum packeterr` error code. */
int packet_r(packet_t *restrict p, void *restrict ptr, const size_t size);
/* Returns `enum packeterr` error code. */
int packet_r_64_t(packet_t *restrict p, void *restrict ptr);
/* Returns `enum packeterr` error code. */
int packet_r_32_t(packet_t *restrict p, void *restrict ptr);
/* Returns `enum packeterr` error code. */
int packet_r_16_t(packet_t *restrict p, void *restrict ptr);
/* Returns `enum packeterr` error code. */
 ...
 * Returns `enum packeterr` error code. */
int packet_rw_packet(packet_t *restrict p_from, packet_t *restrict p_to, const size_t size);
/* Returns `enum packeterr` error code. */
int packet_skip(packet_t *restrict p, const size_t size);
/* Returns `enum packeterr` error code. */
